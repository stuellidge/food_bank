...
class OccupantsControllerTest < ActionController::TestCase
  ...
  test "should create occupant" do
    assert_difference('Occupant.count') do
      post :create, occupant: { date_of_birth: @occupant.date_of_birth, forename: @occupant.forename, sex: @occupant.sex, surname: @occupant.surname, title: @occupant.title }
    end
  ...
  test "should update occupant" do
    put :update, id: @occupant, occupant: { date_of_birth: @occupant.date_of_birth, forename: @occupant.forename, sex: @occupant.sex, surname: @occupant.surname, title: @occupant.title }
    assert_redirected_to occupant_path(assigns(:occupant))
  end
