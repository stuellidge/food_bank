...
class ExpendituresControllerTest < ActionController::TestCase
  ...
  test "should create expenditure" do
    assert_difference('Expenditure.count') do
      post :create, expenditure: { amount: @expenditure.amount, date: @expenditure.date, purpose: @expenditure.purpose, reason: @expenditure.reason }
    end
  ...
  test "should update expenditure" do
    put :update, id: @expenditure, expenditure: { amount: @expenditure.amount, date: @expenditure.date, purpose: @expenditure.purpose, reason: @expenditure.reason }
    assert_redirected_to expenditure_path(assigns(:expenditure))
  end
